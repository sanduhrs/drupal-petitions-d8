  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($flag) {
      ...
      if ($result['result'] !== true) {
        ...
        drupal_set_message($this->t('@emp_name, A confirmation link has been sent to you by email to the following adress: @mail', array('@emp_name' => $form_state->getValue('name'), '@mail'=>$user_mail)));
      }

    // if signature already exists alert the user
    } else {
      drupal_set_message($this->t('@emp_name, You have already signed this petition!', array('@emp_name' => $form_state->getValue('name'))));
    }
