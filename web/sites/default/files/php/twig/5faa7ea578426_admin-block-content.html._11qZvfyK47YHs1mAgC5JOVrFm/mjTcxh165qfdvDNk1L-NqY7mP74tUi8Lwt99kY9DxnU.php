...
class __TwigTemplate_a38409f61a6bc6215c36aa9cba419f24bcc6624f3bf354e53c0eb91d75ba159d extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $filters = ["escape" => 24];
        $functions = ["create_attribute" => 26, "url" => 27];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for'],
                ['escape'],
                ['create_attribute', 'url']
            );
    ...
    ";
        ...
        <a class=\"admin-item__link\" href=\"";
                // line 27
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->getUrl($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["item"], "link", []), "url", []), "routeName", []))));
                echo "\"></a>
...
";
    ...
    {
        return new Source("", "themes/contrib/gin/templates/admin/admin-block-content.html.twig", "/srv/http/drupal/petition/web/themes/contrib/gin/templates/admin/admin-block-content.html.twig");
    }
}
